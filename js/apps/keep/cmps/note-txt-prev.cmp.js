export default {
    props: ['cmp'],
    emits: ['delete', 'edit', 'pin', 'duplicate', 'color', 'screen'],
    template: `
    <section :class="['note-txt']">
        
        <div class="content-container">
            <div class="note-txt-header">
        ...
        <div class="colors-container" v-if="colorPicker" :style="{position: 'absolute', top: yPos + 10 + 'px', left: xPos - 130 + 'px'}">
